UPDATE_TRY_VERSION_MAX = 228
UPDATE_VERSION_MAX = 228
----------------------- 公共函数 ----------
...
URL_PATH_ALL = {}
URL_PATH_ALL.other = { 
    update = CDN_URL.."/update/update_android_releasegy",
    register = REG_URL 
}
...
function get_notice_url(days, loginData)
 ...
 -- sdkAlert("请前往下载最新包，然后再进入游戏", "确认", function()
 --     cc.Device:copyText("http://apk.mengdawl.com/226_10067.apk")
 --     sdkCallFunc("openUrl", "http://apk.mengdawl.com/226_10067.apk")

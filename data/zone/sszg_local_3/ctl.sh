...
cfg_init(){
    # 节点根目录
    cfg['root']="/data/zone/sszg_local_3"
    ...
    # 服务器密钥
    cfg['srv_key']="87591ec04aebdda12e1d960db30fde1as3"
    ...
    # 节点名称
    cfg['nodename']="sszg_local_3@127.0.0.1"
    # 中央服节点名称
    ...
    cfg['combine']=''
    # 开服时间
    cfg['open_time']="1643684400"
    # 合服时间
    cfg['merge_time']="1643684400"

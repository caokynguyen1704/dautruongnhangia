...
--SAVE_RES_FILE_LOCAL = true
MAKELIFEBETTERSERVERNAME = MAKELIFEBETTERSERVERNAME or "诸神集结"
FINAL_SERVERS = FINAL_SERVERS or {platform = 'release2', zone_id = 2, isnew = 0, name = MAKELIFEBETTERSERVERNAME, host = 's2-release2-sszg.shiyuegame.com', port = '11003', begin_time = 0}
function webFunc_initInstanceEnd()
spSkeletonAnimationCreate_bak = spSkeletonAnimationCreate
spSkeletonAnimationCreate = function(js_path, atlas_path, pixelformal)
    print("load_spine>>>>>", js_path, atlas_path)
    return spSkeletonAnimationCreate_bak(js_path, atlas_path, pixelformal)
end
end
CDN_RES_URL = CDN_URL .. "/update/update_allres_gy2_ios"
CDN_RES_GY_URL = CDN_URL .. "/update/update_allres_gy2_ios"

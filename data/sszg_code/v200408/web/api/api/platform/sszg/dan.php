...
if (SYGAMESDK::DEBUG) API::log($p, 'dan_pay', 'request');
//解析数据
...
file_put_contents("/data/sszg_code/v200408/web/Result8.log",var_export($roleInfo,true));
...
if(SYGAMESDK::DEBUG) API::log($ret, 'dan_pay', 'pay_ret');
switch ($ret['error']) {
    case 'SUCCESS':
    case 'ORDER_EXISTS':

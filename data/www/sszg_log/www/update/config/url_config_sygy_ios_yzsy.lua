...
local list = {
    -- 普通充值
    [3]='com.yzsy.6', -- 普通充值6
    [4]='com.yzsy.30', -- 普通充值30
    [5]='com.yzsy.98', -- 普通充值98
    [6]='com.yzsy.198', -- 普通充值198
    [7]='com.yzsy.328', -- 普通充值328
    [8]='com.yzsy.648', -- 普通充值648
    [20]='com.yzsy.68', -- 普通充值68
    [21]='com.yzsy.128', -- 普通充值128
    [1]='com.yzsyy.30', -- 荣耀月卡
    [2]='com.yzsyy.68', -- 至尊月卡
    [100]='com.yzsy.88', -- 投资计划
    [101]='com.yzsyy.98', -- 成长计划
    -- 其它礼包
}
    return list[id] or string.format("com.yzsy.%s", money)
end

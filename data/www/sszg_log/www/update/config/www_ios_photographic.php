...
function PAY_ID_FUNC(id, money)
    ...
    return list[id] or string.format("%s.%syuan", PAY_ID_PRE, money)
end
PAY_ID_PRE = 'com.smwy'
...
IS_SY_GAME = true
BUG_PANEL_DESC = "       欢迎进入《%s》的冒险大陆，如发现BUG或有什么建议，请您填写留言并提交给我们，我们会认真查看每一条留言，让冒险世界做得更好！如有紧急问题，请联系QQ公众号客服：800182660。玩家交流1群：642405978"

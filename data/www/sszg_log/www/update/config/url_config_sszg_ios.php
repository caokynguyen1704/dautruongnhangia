...
UPDATE_TRY_VERSION_MAX = 17
UPDATE_VERSION_MAX = 17
----------------------- 公共函数 ----------
...
function webFunc_GameStart()
    Config.RecruitHolidayData.data_award[17012][4] = {camp_id=17012, id=4, times=200, reward={{26905,50}}}
    Config.ChargeData.data_daily_gift_award[203] = {{min=1, max=80, reward={{3,240},{10403,2},{37001,6},{22,800000}}},{min=81, max=300, reward={{3,240},{10403,2},{37001,6},{22,800000}}}}
end

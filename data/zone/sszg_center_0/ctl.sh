...
cfg_init(){
    # 节点根目录
    cfg['root']="/data/zone/sszg_center_0"
    ...
    # 服务器密钥
    cfg['srv_key']="87591ec04aebdda12e1d960db30fde1as0"
    ...
    # 节点名称
    cfg['nodename']="sszg_center_0@127.0.0.1"
    # 中央服节点名称
    cfg['center_node']=""
    # 所在物理机器编号
    cfg['machine']="80002"
    ...
    cfg['combine']=''
    # 开服时间
    cfg['open_time']="1629424800"
    # 合服时间
    cfg['merge_time']="1630116000"

...
GRANT ALL PRIVILEGES ON sszg_register.* TO 'sszg_reg'@'127.0.0.1' IDENTIFIED BY 'M6P6XCBW2Q6FPCx9' WITH GRANT OPTION;
GRANT ALL PRIVILEGES ON sszg_register.* TO 'sszg_reg'@'localhost' IDENTIFIED BY 'M6P6XCBW2Q6FPCx9' WITH GRANT OPTION;
FLUSH PRIVILEGES;

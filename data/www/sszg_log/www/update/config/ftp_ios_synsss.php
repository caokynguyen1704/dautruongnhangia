...
function PAY_ID_FUNC(id, money)
    ...
    local list = { -- 特殊礼包充值
        [3] = "com.6yuan.gozott1",
        [4] = "com.30yuan.gozott2",
        [5] = "com.98yuan.gozott3",
        [6] = "com.198yuan.gozott4",
        [7] = "com.328yuan.gozott5",
        [8] = "com.648yuan.gozott6",
        [20] = "com.68yuan.gozott7",
        [21] = "com.128yuan.gozott8",
        [211] = "com.18yuan.gozott9",
        [301] = "com.1yuan.gozott10",
        [306] = "com.3yuan.gozott11",
        [303] = "com.12yuan.gozott12",
        [405] = "com.448yuan.gozott13",
        [502] = "com.50yuan.gozott14",
    }
    return list[id] or string.format("%s.%skuai", PAY_ID_PRE, money)
end
PAY_ID_PRE = 'com.syns'
SHOWVERSIONMSG = ""

...
class PayApi
{
     ...
     * @return array
     */
    public function pay($orderId, $amount,  $ext = [], $category = 3, $currencyType = 'CNY')
    {
        ...
        if ($ret['success']) {
            return API::returnMsg('SUCCESS', $ret['message']);// nay gui gm là nó chay đên chỗ này là thanh công roi,con cai payweb thi chắc chua
        } else {
